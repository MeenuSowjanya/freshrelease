...
## Hello🖐 ! Welcome to Welome to [ZUPP](https://zupp-ticket-app-test.herokuapp.com/) 
...
##### I am Meenu Sowjanya and this is my project , a Ticket Management Software built on Rails which supports 2 user persona and roles: **admin** and **agent**.

##### Here different users get different views of the application, depending upon the roles assigned to them : [ "admin" , "agent"].

### To get complete ZOOPER experience of this platform visit [ZUPP](https://zupp-ticket-app-test.herokuapp.com/)_* and login via *admin* role

######
| First Name | Last Name | Email | Password | Role |
|---- |-----|-------|----|-----|
| Admin | Admin | admin@gmail.com | Admin@1234 | admin |
| Agent | Org | agent@gmail.com | Agent@1234 | agent |
######
